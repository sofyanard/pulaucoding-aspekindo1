<div class="container mt-2">
    ...
    <p>
        <h5><a href="<?= base_url('summary/summary5'); ?>">Jumlah Anggota Berdasarkan Sub Bidang</a></h5>
    </p>

    <form action="<?= base_url('summary/summary5z'); ?>" method="POST">
        ...
        <tbody>
            ...
            <?php foreach($result as $row) : ?>
                ...
                <?php } ?>
                    ...
                    <td><a href="<?= base_url('anggota/display?subbidang=').$row['SubBidangCode']; ?><?= ($this->uri->segment(3) != '') ? '&propinsi='.$this->uri->segment(3) : '' ?><?= ($this->uri->segment(4) != '') ? '&kota='.$this->uri->segment(4) : '' ?>&from=<?= current_url(); ?>"><?= $row['Jumlah']; ?></a></td>
                </tr>
